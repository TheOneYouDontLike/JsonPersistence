...
var getRewiredJsonPersistenceWithoutInjectedMock = function(fileName, fsMock) {
    JsonPersistence.__set__('fs', fsMock);

    return new JsonPersistence(fileName);
}

var getJsonPersistenceWithInjectedMock = function(fileName, fsMock) {
    return new JsonPersistence(fileName, fsMock);
}

var persistenceTestSuite = function(getJsonPersistence) {
    return function () {
...
describe('jsonPersistence working on fs', persistenceTestSuite(getRewiredJsonPersistenceWithoutInjectedMock));

describe('jsonPersistence working on injected file system', persistenceTestSuite(getJsonPersistenceWithInjectedMock));